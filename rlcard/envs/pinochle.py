...
from rlcard.games.pinochle import Game

from rlcard.games.pinochle.game import PinochleGame
from rlcard.games.pinochle.utils.action_event import ActionEvent
from rlcard.games.pinochle.utils.pinochle_card import PinochleCard
from rlcard.games.pinochle.utils.move import CallMove, PlayCardMove
...
class PinochlePayoffDelegate(object):
    ...
    def get_payoffs(self, game: PinochleGame):
...
class PinochleStateExtractor(object):  # interface
    ...
    def extract_state(self, game: PinochleGame):
        ''' Extract useful information from state for RL. Must be implemented in the child class.

        Args:
            game (PinochleGame): The game
    ...
    @staticmethod
    def get_legal_actions(game: PinochleGame):
        ''' Get all legal actions for current state.
    ...
    def extract_state(self, game: PinochleGame):
        ...
        if game.round.is_bidding_over() and not game.is_over() and game.round.play_card_count == 0:
            ...
            if contract_bid_move:
                ...
                bid_suit_index = 4 if not bid_suit else PinochleCard.suits.index(bid_suit)
