...
from .judger import PinochleJudger
from .round import PinochleRound
...
class PinochleGame:
    ...
    def __init__(self, allow_step_back=False):
        '''Initialize the class PinochleGame
        '''
        self.allow_step_back: bool = allow_step_back
        self.np_random = np.random.RandomState()
        self.judger: PinochleJudger = PinochleJudger(game=self)
        self.actions: [ActionEvent] = []  # must reset in init_game
        self.round: PinochleRound or None = None  # must reset in init_game
