...
class PinochleRound:
    ...
    def __init__(self, num_players: int, board_id: int, np_random):
        ...
        self.dealer: PinochleDealer = PinochleDealer(self.np_random)
        ...
        self.move_sheet: List[PinochleMove] = []
    ...
    def get_current_player(self) -> PinochlePlayer or None:
    ...
    def get_declarer(self) -> PinochlePlayer or None:
        declarer = None
        if self.contract_bid_move:
            trump_suit = self.contract_bid_move.action.bid_suit
    ...
    def get_dummy(self) -> PinochlePlayer or None:
        dummy = None
    ...
    def get_left_defender(self) -> PinochlePlayer or None:
        left_defender = None
        declarer = self.get_declarer()
        if declarer:
    ...
    def get_right_defender(self) -> PinochlePlayer or None:
        right_defender = None
        declarer = self.get_declarer()
        if declarer:
